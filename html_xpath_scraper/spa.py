...
class HeySpaSpider(scrapy.Spider):
	name = 'heyspa'
	allowed_domain = 'https://heyspa.co.za/'
	start_url = 'https://heyspa.co.za/'
	root_url = 'https://heyspa.co.za'
	# allowed_location_list = ['Cape_Town', 'Johannesburg', 'Pretoria', 'Durban', 'Port_Elizabeth', 'Bloemfontein']
	allowed_location_list = ['Johannesburg']
