...
class CartridgeworldSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for location in self.us_location_list:
            ...
            # url = 'https://www.cartridgeworld.com/store/search?SearchQuery=' + location['city'].replace(' ', '+') + '&SourceLatitude=' + location['latitude'] + '&SourceLongitude=' + location['longitude']
        ...
        # url = 'https://www.cartridgeworld.com/store/search?SearchQuery=New+York&SourceLatitude=40.7127837&SourceLongitude=-74.00594130000002'
        # yield scrapy.Request(url=url, callback=self.body)
