...
class HeyBedBreakfastSpider(scrapy.Spider):
	name = 'heybedbreakfast'
	allowed_domain = 'https://heybedbreakfast.co.za/'
	start_url = 'https://heybedbreakfast.co.za/'
	root_url = 'https://heybedbreakfast.co.za'
